...
def LIGHTON(phrase):
    say("stand on")
    os.system('python /home/pi/sound_lighton.py')

def LIGHTOFF(phrase):
    say("stand off")
    os.system('python /home/pi/sound_lightoff.py')

def MOTORUP(phrase):
    say("motor up")
    os.system('python /home/pi/sound_motorup.py')

def MOTORDOWN(phrase):
    say("motor down")
    os.system('python /home/pi/sound_motordown.py')
